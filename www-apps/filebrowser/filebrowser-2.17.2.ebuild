...
NPM_RESOLVED=(
	...
	"browserslist/-/browserslist-4.16.3.tgz"
	...
	"caniuse-lite/-/caniuse-lite-1.0.30001203.tgz"
	...
	"dns-packet/-/dns-packet-1.3.1.tgz"
	...
	"ejs/-/ejs-2.7.4.tgz"
	"electron-to-chromium/-/electron-to-chromium-1.3.693.tgz"
	...
	"follow-redirects/-/follow-redirects-1.13.3.tgz"
	...
	"material-design-icons/-/material-design-icons-3.0.1.tgz"
	...
	"node-releases/-/node-releases-1.1.71.tgz"
	...
	"webpack-dev-server/-/webpack-dev-server-3.11.2.tgz"
...
EGO_SUM=(
	...
	"github.com/pierrec/lz4 v0.0.0-20190131084431-473cd7ce01a1/go.mod"
...
src_compile() {
	...
	go build -v -work -o . -trimpath -ldflags "${goldflags}" || die
}
