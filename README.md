...
--------------------------------------------|-------------------|--------|------------------------------------------------|--------------------
 app-crypt/keybase                          | 6.0.2-r1          |        | https://keybase.io/                            | Keybase command-line utility, and local service
   dev-lang/go                              | 1.19.5            | BD     | https://go.dev                                 | A concurrent garbage collected and typesafe programming language
                                            | 1.20              |        |                                                |
...
--------------------------------------------|-------------------|--------|------------------------------------------------|--------------------
 dev-util/act                               | 0.2.42            |        | https://github.com/nektos/act                  | Run your GitHub Actions locally
--------------------------------------------|-------------------|--------|------------------------------------------------|--------------------
