...
EGO_SUM=(
	...
	"github.com/xtls/go v0.0.0-20200921133830-416584838a0f/go.mod"
...
DEPEND="!net-proxy/v2ray-bin dev-lang/go:="
...
src_compile() {
	...
	go build -work -o "bin/v2ctl" -ldflags "-s -w" ./infra/control/main
}
